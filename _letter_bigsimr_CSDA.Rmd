...
The entire article can be reproduced from code and is housed at [https://github.com/SchisslerGroup/article_bigsimr](https://github.com/SchisslerGroup/article_bigsimr), which we are glad to make available upon request to the reviewers and, after acceptance, the general public.
