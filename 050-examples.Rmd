...
The `R` summary function supplies the mean-augmented five-number summary of the Frobenius loss distribution computed above.
...
This distribution could be compared to bespoke HD covariance estimators for guidance on whether the additional complexity and computation time are warranted.
