...
matrixcalc::is.symmetric.matrix( R_X )
all(diag(R_X) == 1)
cor_nearPSD( G = R_X )
```
...
We note that the bounds on the Pearson correlation coefficient $R_P$ between these margins is restricted as seen below:
