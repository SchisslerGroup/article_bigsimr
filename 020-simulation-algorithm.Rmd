...
```{r previewChapter020, echo = FALSE, eval = FALSE}
...
they can become non-positive definite through either during estimation (if done pairwise) or through the algorithm's 
