...
Later, we'll study the robustness of our method to this limitation in selected [Monte Carlo evaluations]({#simulations}).
...
To overcome this issue, we've developed `bigsimr::nearPSD`, a quadractically-convergent Newton method for finding the nearest correlation matrix, developed by @QS2006.
