...
```{r rvec1e6, fig.width=7, eval = FALSE}
...
```{r computeBounds, echo = FALSE, eval=FALSE}
...
```{r rvecRslurm, echo=FALSE, eval=FALSE}
library(rslurm)
...
```{r rvecRslurmRes, echo=FALSE, eval=FALSE}
...
```{r rvecRslurmMap, echo=FALSE, eval=FALSE}
library(rslurm)
## a single call of rvec
...
```{r rvecRslurmMapRes, echo=FALSE, eval=FALSE}
