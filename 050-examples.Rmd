...
While the exact dxd Spearman correlation matrix is not strictly admissible in our scheme (seen by the non-PSD result above), the approximation is of sufficient quality for most applications with a maximum pairwise of `r max( targets - approximations)` and average error of `r mean( targets - approximations)`.
