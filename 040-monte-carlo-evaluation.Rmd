...
\setstretch{1.5}
1. a) Estimate the correlation matrix from the "data" in the *Compute Correlation* step.
1. b) Map the correlations to initialize the algorithm (Pearson to Pearson, Spearman to Pearson, or Kendall to Pearson) in the *Adjust Correlation* step.
