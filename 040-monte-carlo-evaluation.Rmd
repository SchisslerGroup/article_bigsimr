...
Table XX lists our identical-marginal, bivariate simulation configurations.
...
```{r ch040-biMSEtable, results='asis'}
## tabMSE  <- allDat %>%
##    group_by( N, margins ) %>%
...
Table \@ref(tab:ch040-biMSEtable) contains the average absolute error (MAE) in reproducing the desired dependency measures for the three bivariate scenarios.
