---
subtitle: "Simulating Ultra High-Dimensional Multivariate Data"
author:
  - "Alfred G. **Schissler**, PhD"
  - "Alexander D. **Knudson**, MS"
  - "Tomasz J. **Kozubowski**, PhD"
  - "Anna K. **Panorska**, PhD"
  - "Juli **Petereit**, PhD"
...
- An article motivating, describing, and applying the methods; archived [here](???).
...
```{r ch050-simDataFig, echo=F, fig.align='center', fig.cap='Simulated data for three selected high-expressing genes replicates the estimated data structure.', fig.show = 'hold', out.width='40%', fig.asp=1}
## knitr::include_graphics("../fig/realDataFig.png")
...
* (Nearly) exact Pearson matching is not supported.
...
### CFE-CMSTATS 2020 organizers

 - Thanks to everyone who makes this event possible!
 - Professor Anna Panorska for the invitation to speak today.
